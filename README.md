...
![image](https://github.com/YeLiu-Lab/CANDIES/blob/main/CANDIES.png)
...
In the paper, we compared CANDIES with 9 unimodal clustering methods, 3 non-spatial multi-omics integration approaches, and 4 spatial multi-omics integration techniques.
